		...
		<header className={navbarIsShow?"navbar navbar-show":"navbar"}>
			<nav className="container navbar-menu">
				...
				<div className={navbarIsOpen?"main-navbar main-navbar-open":"main-navbar"}>
					<Link to="custon" className="btn-link" onClick={navbarCloseHandler} smooth={true} duration={600}>Custom</Link>
					<Link to="contact" className="btn-link" onClick={navbarCloseHandler} smooth={true} duration={600}>Contact</Link>
					<Link to="service" className="btn-link" onClick={navbarCloseHandler} smooth={true} duration={600}>Service</Link>
					<NavLink to="/login" className="btn-link" onClick={navbarCloseHandler}>Sign Up</NavLink>
                </div>
